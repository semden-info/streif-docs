...
**Стан 2026-07-27:** #12/#13/#14 (усі три 🟠 major) — ✅ виправлено й влито (`4b162f9`, 310 тестів,
`lintVitalRelease` зелений). Відкритими лишаються **#15, #16, #17** (усі 🟡 minor) + **#11** з §B.6.3 і
розсинхрон `play-fgs-declaration.md` §2.1 нижче.
