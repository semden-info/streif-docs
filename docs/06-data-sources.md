...
**Landmarks для діорами (`04` §11.2 / P22):** знакові будівлі/споруди — Kartverket matrikkel-типи + Riksantikvaren (культурні пам'ятки); джерела уточнити.
