...
| Shared? (усі чотири) | **No** | Дані йдуть на **наш** Cloudflare Worker → **наше** R2. Cloudflare — обробник (той самий, що вже віддає тайли), не третя сторона-отримувач. Ніяких рекламних чи аналітичних SDK у застосунку немає |
